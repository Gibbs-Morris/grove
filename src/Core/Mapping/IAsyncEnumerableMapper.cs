...
/// <summary>
/// Defines a generic interface for mapping asynchronous collections of objects of type <typeparamref name="TFrom"/> to asynchronous collections of objects of type <typeparamref name="TTo"/>.
/// </summary>
